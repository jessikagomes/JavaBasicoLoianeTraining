...
public class JogoDaVelha {
	...
	public static void main(String[] args) {
		...
		// enquanto ninguém ganhou a gente continua o jogo
		while (!ganhou) {
			...
			while (!linhaValida) { // enquanto não escolhar uma linha válida continua perguntando
			...
			while (!colunaValida) {// enquanto não escolher uma coluna válida continua perguntando
			...
			if ((jogoVelha[0][0] == 'x' && jogoVelha[0][1] == 'x' && jogoVelha[0][2] == 'x') || // linha 1
				...
				ganhou = true;
				System.out.print("Ninguém ganhou essa partida!");
			}
